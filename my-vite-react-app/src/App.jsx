     ...
     <div>
      ...
      <div className="container3 mx-auto py-8 grid grid-cols-1 md:grid-cols-2 items-center gap-4 "> 
        <div className="space-y-6">
          ...
          <a href="https://www.linkedin.com/in/ashanka-dongare-3b914225a/"  className="home__social-icon">
                        <FaLinkedin />
                    </a>
              <a href="https://twitter.com"  className="home__social-icon">
                        <FaTwitter />
                    </a>
            <a href="https://github.com/ashanka710/Trainee-plutonium" className="home__social-icon">
                        <FaGithub />
                    </a>
          ...
          <div className="space-y-4">
            ...
            <div className="space-x-4">
              <a
                ...
                className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition duration-300  shadow-lg"
              >
                Download CV<i className="uil uil-download-alt ml-2 shadow-md "></i>
              </a>
              <a
                href="#contact"
                className="bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-900 transition duration-300   shadow-lg"
              >
